...
for i = 1 : features - 4
for j = i + 1 : features - 3
for k = j + 1 : features - 2
for l = k + 1 : features - 1
    for m = l + 1 : features
       resultsAux = zeros(tests, dataToSave);
       
       for it = 1 : tests
           message      = sprintf('* %d * [1-2] Dimensiones %d - %d - %d - %d - %d *', ...
            it, i, j, k, l, m);
           disp(message);
           ...
           message      = sprintf('[1-2] Dimensiones %d - %d - %d - %d - %d !OK!', ...
               i, j, k, l, m);
...
for l = k + 1 : features - 1
    for m = l + 1 : features
       ...
       for it = 1 : tests
           message      = sprintf('* %d * [1-3] Dimensiones %d - %d - %d - %d - %d *', ...
            it, i, j, k, l, m);
           disp(message);
           ...
           message      = sprintf('[1-3] Dimensiones %d - %d - %d - %d - %d !OK!', ...
               i, j, k, l, m);
...
for l = k + 1 : features - 1
    for m = l + 1 : features
       ...
       for it = 1 : tests
           message      = sprintf('* %d * [2-3] Dimensiones %d - %d - %d - %d - %d *', ...
            it, i, j, k, l, m);
           disp(message);
           ...
           message      = sprintf('[2-3] Dimensiones %d - %d - %d - %d - %d !OK!', ...
               i, j, k, l, m);
