...
for m = l + 1 : features - 1
    for n = m + 1 : features
       ...
       for it = 1 : tests
           message      = sprintf('* %d * [1-2] Dimensiones %d - %d - %d - %d - %d - %d *', ...
            it, i, j, k, l, m, n);
           disp(message);
           ...
           message      = sprintf('[1-2] Dimensiones %d - %d - %d - %d - %d - %d !OK!', ...
               i, j, k, l, m, n);
...
for m = l + 1 : features - 1
    for n = m + 1 : features
       ...
       for it = 1 : tests
           message      = sprintf('* %d * [1-3] Dimensiones %d - %d - %d - %d - %d - %d *', ...
            it, i, j, k, l, m, n);
           disp(message);
           ...
           message      = sprintf('[1-3] Dimensiones %d - %d - %d - %d - %d - %d !OK!', ...
               i, j, k, l, m, n);
...
for m = l + 1 : features - 1
    for n = m + 1 : features
       ...
       for it = 1 : tests
           message      = sprintf('* %d * [2-3] Dimensiones %d - %d - %d - %d - %d - %d *', ...
            it, i, j, k, l, m, n);
           disp(message);
           ...
           message      = sprintf('[2-3] Dimensiones %d - %d - %d - %d - %d - %d !OK!', ...
               i, j, k, l, m, n);
