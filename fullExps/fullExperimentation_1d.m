...
% 
%   for it = 1 : tests
%      message      = sprintf('* %d * [1-2] Dimensiones %d *', ...
%       it, i);
%      disp(message);
% 
...
% 
%      message      = sprintf('[1-2] Dimensiones %d !OK!', ...
%          i);
...
for i = 1 : features
 ...
 for it = 1 : tests
     message      = sprintf('* %d * [1-3] Dimensiones %d *', ...
      it, i);
     disp(message);
     ...
     message      = sprintf('[1-3] Dimensiones %d !OK!', ...
         i);
...
for i = 1 : features
  ...
  for it = 1 : tests
     message      = sprintf('* %d * [2-3] Dimensiones %d *', ...
      it, i);
     disp(message);
     ...
     message      = sprintf('[2-3] Dimensiones %d !OK!', ...
         i);
